function visualize!(vis, model::Drone, Q, U;
    Δt=0.1,
    r=0.05, 
    ...
    body = Cylinder(Point3f0(-0.5 * model.body_length, 0.0, 0.0), Point3f0(0.5 * model.body_length, 0.0, 0.0), convert(Float32, r))
    thruster1 = Cylinder(Point3f0(0.0, 0.0, -0.25 * model.body_length), Point3f0(0.0, 0.0, 0.15 * model.body_length), convert(Float32, 0.65 * r))
    thruster2 = Cylinder(Point3f0(0.0, 0.0, -0.25 * model.body_length), Point3f0(0.0, 0.0, 0.15 * model.body_length), convert(Float32, 0.65 * r))
    thrust1 = Cylinder(Point3f0(0.0, 0.0, -0.3 * model.body_length), Point3f0(0.0, 0.0, 0.0), convert(Float32, 0.35 * r))
    thrust2 = Cylinder(Point3f0(0.0, 0.0, -0.3 * model.body_length), Point3f0(0.0, 0.0, 0.0), convert(Float32, 0.35 * r))
